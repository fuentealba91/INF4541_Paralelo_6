<?php 
	...
	$registros = mysqli_query($conexion,"SELECT pa.id, pa.idActividad, pa.idPersona, p.nombre, p.a_paterno, p.a_materno, pa.asistio FROM persona_actividad pa 
    INNER JOIN persona p ON pa.idPersona = p.id_Persona WHERE pa.idActividad = $_GET[id]");

<?php 
	...
	$registros = mysqli_query($conexion,"SELECT pc.idCategoria, d.nombre FROM persona_categoria pc 
	INNER JOIN categoria c ON pc.idCategoria = c.idCategoria INNER JOIN deporte d ON c.id_deporte = d.idDeporte WHERE pc.idPersona = $_GET[id]");

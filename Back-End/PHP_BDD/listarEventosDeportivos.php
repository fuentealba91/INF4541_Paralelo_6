<?php 
	...
	INNER JOIN tipo_actividad ta ON act.tipo = ta.idTipo_Actividad ORDER BY act.fecha DESC");
	...
	// FROM actividad act INNER JOIN deporte dep ON act.deporte = dep.idDeporte INNER JOIN tipo_actividad ta ON act.tipo = ta.idTipo_Actividad");

<?php 
	...
	$registros = mysqli_query($conexion,"SELECT pr.id, pr.persona, pr.reunion, p.nombre, p.a_paterno, p.a_materno, pr.asistio FROM persona_reunion pr 
    INNER JOIN persona p ON pr.persona = p.id_Persona WHERE pr.reunion = $_GET[id]");

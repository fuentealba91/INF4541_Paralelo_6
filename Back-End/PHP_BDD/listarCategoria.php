<?php 
	...
	$registros = mysqli_query($conexion,"SELECT c.idCategoria,c.nombre,c.estado,c.fecha,c.genero,c.edad,c.cupo,c.entrenamientos,c.valores,c.id_deporte,d.nombre as 'deporte' FROM categoria c INNER JOIN deporte d ON c.id_deporte = d.idDeporte");
